...
Output: pems08\_distance\_matrix.npy will be saved in your processed data folder.
...
python dataprocess.py --traffic\_df\_filename data/PEMS08/PEMS08.npz --output\_dir data/processed/PEMS08/
