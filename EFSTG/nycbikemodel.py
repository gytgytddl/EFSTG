...
class EFSTG(nn.Module):
    ...
    def __init__(self, device, input_dim, num_nodes, channels, out_dim=2, real_adj=None, granularity=288, dropout=0.2,
                 gc_gate_init=0.2, graph_alpha_init=0.1, k=15, **kwargs):
        super().__init__()
        self.input_len = 12
        self.output_len = 12
        ...
        self.temporal_conv = TemporalConvNet_SiLU(hidden_dim, kernel_size=3, levels=3, dropout=dropout)
    ...
    def forward(self, x):
        ...
        h_freq, _ = self.dynamic_gcn(self.euler(h_local))
